...
const seeding = async() => {
    ...
    await User.create({ name: 'tester', email: 'test@example.com', password: 'helloworld', role: 'user' })
    await User.create({ name: 'admin', email: 'admin@example.com', password: 'admini', role: 'admin' })
